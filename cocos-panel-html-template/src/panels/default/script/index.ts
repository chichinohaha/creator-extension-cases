 ...
 * @zh 面板的内容
 */
export const template = readFileSync(join(__dirname, '../template/index.html'), 'utf-8');

/**
 * @en Style of the panel 
 * @zh 面板上的样式
 */
export const style = readFileSync(join(__dirname, '../style/index.css'), 'utf-8');
